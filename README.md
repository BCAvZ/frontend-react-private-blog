...
3. BlogOverzicht Overzicht pagina (`/blogposts`)
4. Blogpost pagina (`/blogposts/:blogId`)

* Zorg ervoor dat er *content* op die pagina's komt te staan:
    * Maak een navigatiebalk met de links naar de Home Pagina, Login pagina en BlogOverzicht Overzicht pagina. Zorg dat deze op
    ...
    * De **BlogOverzicht Overzicht pagina** bevat de totale hoeveelheid posts (*getal*) en alle blog-titels. De titels zijn links
...
* Wanneer de bezoeker *niet* ingelogd is, zijn zowel de blogposts als de BlogOverzicht Overzichtpagina niet te bezoeken. Dit zijn
  dus **private routes**!
...
- Wanneer de bezoeker *niet* ingelogd is, moet er een "inloggen"-link in de navigatie aanwezig zijn. Deze wijst naar de
  Login pagina.
- Wanneer de bezoeker *niet* ingelogd is, is de link naar de BlogOverzicht Overzichtpagina *niet* aanwezig.
